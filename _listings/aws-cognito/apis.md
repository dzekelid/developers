...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/developers/master/_listings/aws-cognito/apis.md
...
- name: AWS Cognito Merged API - Get Open Id Token For Developer Identity
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/developers/master/_listings/aws-cognito/actiongetopenidtokenfordeveloperidentity-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/developers/master/_listings/aws-cognito/actiongetopenidtokenfordeveloperidentity-get-openapi.md
- name: AWS Cognito Merged API - Lookup Developer Identity
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/developers/master/_listings/aws-cognito/actionlookupdeveloperidentity-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/developers/master/_listings/aws-cognito/actionlookupdeveloperidentity-get-openapi.md
- name: AWS Cognito Merged API - Get Open Id Token For Developer Identity
  x-api-slug: actiongetopenidtokenfordeveloperidentity-get
  description: |-
    Registers (or retrieves) a Cognito IdentityId and an OpenID Connect
...
- name: AWS Cognito Merged API - Merge Developer Identities
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/developers/master/_listings/aws-cognito/actionmergedeveloperidentities-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/developers/master/_listings/aws-cognito/actionmergedeveloperidentities-get-openapi.md
- name: AWS Cognito Merged API - Lookup Developer Identity
  x-api-slug: actionlookupdeveloperidentity-get
  description: |-
    Retrieves the IdentityID associated with a
...
- name: AWS Cognito Merged API - Unlink Developer Identity
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/developers/master/_listings/aws-cognito/actionunlinkdeveloperidentity-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/developers/master/_listings/aws-cognito/actionunlinkdeveloperidentity-get-openapi.md
- name: AWS Cognito Merged API - Merge Developer Identities
  x-api-slug: actionmergedeveloperidentities-get
  description: |-
    Merges two users having different IdentityIds, existing in the same
